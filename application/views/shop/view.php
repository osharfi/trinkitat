					...
					<div id="table">
						<table>
							<tr class="tabletitle">
								...
								<td class="Hours"><h2>السعر</h2></td>
								<td class="Rate"><h2>الكمية</h2></td>
								<td class="Rate"><h2>المبلغ</h2></td>
...
<?php foreach ($order_item as $order_items): ?>
							<tr class="service">
								...
								<td class="tableitem"><p class="itemtext">
								<?php echo $order_items['ltotal']; ?> ج
								</p></td>
								<td class="tableitem"><p class="itemtext">
								<?php echo $order_items['quantity']; ?>
								</p></td>
								<td class="tableitem"><p class="itemtext">
								<?php echo $order_items['ltotal']*$order_items['quantity']; ?> ج
								</p></td>
							</tr>
<?php endforeach; ?>
							<tr class="tabletitle">
					
								<td class="Rate"><h2>الجملة</h2></td>
																<td></td>
								<td></td>

								<td class="payment"><h2><?php echo $order_item[0]['total']; ?> ج</h2></td>
							</tr>
