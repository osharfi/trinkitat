    ...
    <div class="row">
        <div class="col-12">
			...
			<h1>المبيعات</h1>
                <h2>
    <a class="nav-link" href="<?php echo base_url('order/newc'); ?>">فاتورة</a>
                </h2>
            </div>
		...
		<tr id="<?php echo $order_item['orderid']; ?>">
				...
				<td>
					<?php  echo "
						...
						echo "<a href='". site_url('order/pay/'.$order_item['orderid'])." '> سداد </a>";
					
					if($this->session->userdata('level')==='1')
						echo "<a href='". site_url('order/delete/'.$order_item['orderid'])."' onclick='return confirm(\"هل تريد مسح الايصال رقم".$order_item['orderid']."\")' class='btn btn-danger remove'> مسح </a>";
					?>
				</td>
		</tr>
		<?php endforeach; ?>
