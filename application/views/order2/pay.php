...
<?php echo form_open('order2/pay/'.$order_item[0]['orderid']); ?>	
...
<label class="radio-inline"><input type="radio" value="2" name="pmethod">بنك</label>
  ...
  <input type="text" class="form-control"  name="total" id="total"  value="<?php echo $order_item[0]['total']-$order_item[0]['paid'];
								 ?>" hidden />
  <input type="text" class="form-control"  name="oldpaid" id="oldpaid"  value="<?php echo $order_item[0]['paid'];
								 ?>" hidden />	
